...
abstract class DatabaseDatasource {
  ...
  /// Removes an element from the database
  Future<QueryResult> deleteQuery(GetQuery query);

  /// Retrieves all elements through the datasource name (collection, table, etc)
  Future<QueryResult> getAll(String sourceName, [int? limit]);

  /// Saves or updates multiple elements to the database through a list of [SaveQuery].
  Future<QueryResult> saveInBatch(List<SaveQuery> queries);
}
